...
public class BankAccountRestAPI {
    ...
    public DebitDTO debit(@RequestBody DebitDTO debitDTO) throws BankAcountNotFoundException, BalanceNotSufficientException {
    ...
    public void transfer(@RequestBody TransferRequestDTO transferRequestDTO) throws BankAcountNotFoundException, BalanceNotSufficientException {
